...
if __name__ == "__main__":
    ...
    if Stijn:
        ...
        save_to = "D:\Onedrive\Leuven\Final project\Results\Forecasting"
    else:
        path_history = "Path is not yet indicated."
        path_temperature = "Path is not yet indicated."
        save_to = "Path is not yet indicated."
    ...
    for col_name in fullYeardata.columns:
        ...
        run.log_table(name="Vertical stacked table", value=vertical_stack.to_dict())
        for method in ["MSE","RMSE","NRMSE","MAE"]:
            ...
            run.log_image(name="Serie"+str(col_name) + "_" + method + "_basemodel.png",plot=axis)
