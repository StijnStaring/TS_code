...
if __name__ == "__main__":
    ...
    # results file
    with open('./output_arrays_stateful/output_file.txt', 'w') as file:
    ...
    list_lag_value = [1]
    for name in names:
        with open('./output_arrays_stateful/output_file.txt', 'a') as file:
        ...
        for lag_value in list_lag_value:
            ...
            # saving the matrices
            np.save("./output_arrays_stateful/X_" + name+"_"+str(lag_value)+".npy", X_train)
            np.save("./output_arrays_stateful/y_" + name + "_" + str(lag_value) + ".npy", y_train)
